...
import { updateInputFirstName, updateInputLastName, resetInputs, updateInputBirthDate, updateInputStartDate, updateInputDepartment, updateInputAddressStreet, updateInputAddressCity, updateInputAddressState, updateInputAddressZip, updateIsModalOpen } from "../slices/formSlice";
import DatePickerCustom from "../components/DatePicker";
import { Modal } from "../components/Modal/Modal";
import useModal from "../components/Modal/useModal";
import MyComponentContent from "../components/common/MyComponentContent";
...
const Form = () => {
  ...
  return (
    <>
      ...
      <Modal modalClass={"testmodal"} isShowing={isShowing} toggle={toggle}>
        <p>
